...
const SAPIBase = "http://127.0.0.1:8080";

const SignUpPage = () => {
  const [ NickName, setNickName ] = React.useState<string>("Please write your nickname");
  ...
  return (
    <div className={"account"}>
      ...
      <div className={"account-item"}>
        ...
        <div className={"account-create-button"} onClick={(e) => createNewAccount()}>Create your account!</div>
      </div>
    </div>
  );
}
